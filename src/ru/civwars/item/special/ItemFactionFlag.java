...
public class ItemFactionFlag extends CustomItem {

    public ItemFactionFlag(@NotNull CustomItem.Property property) {
        super(property);
    }
    ...
    public static class Serializer extends CustomItem.Serializer<ItemFactionFlag> {

        public Serializer() {
            super("faction_flag", ItemFactionFlag.class);
        }

        @NotNull
        @Override
        public void serialize(@NotNull JsonObject object, @NotNull ItemFactionFlag item, @NotNull JsonSerializationContext context) {
        }

        @NotNull
        @Override
        public ItemFactionFlag deserialize(@NotNull JsonObject object, @NotNull JsonDeserializationContext context, @NotNull CustomItem.Property property) {
            return new ItemFactionFlag(property);
        }
    }
